...
dust_phase_file = os.path.join(get_data_path(), 'planets/mars/aux/dust_phase_functions.npy')
...
dust_phase = EmpiricalPhaseFunction(dust_column, phase_function_file=dust_phase_file, wavelengths_file=dust_phase_wavs, particle_sizes_file=dust_phase_radii)
ice_phase = EmpiricalPhaseFunction(ice_column, phase_function_file=ice_coeff)
...
# Add ice and Rayleigh scattering to the model. Dust doesn't do anything since I'm not adding it to the model
...
# This code gives: 0.02927366
# disort_multi gives: 0.0291058850    (we differ by 0.6%)
