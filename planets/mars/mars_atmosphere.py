...
class AtmosphericDust(Atmosphere):
    def __init__(self, atmosphere_file, dust_file, dust_scale_height, conrath_nu, column_optical_depth, wavelength):
...
dust = AtmosphericDust(atmfile, dustfile, 10, 0.5, 1, 9.3)
