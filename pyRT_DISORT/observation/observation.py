...
class Observation:
    ...
    def __check_emission_angles_are_physical(self):
        ...
        emission_angle_checker.check_ndarray_is_in_range(0, 180)
    ...
    def __compute_phi(self):
        sin_emission_angle = np.cos(np.radians(90 - self.emission_angle))
        sin_solar_zenith_angle = np.cos(np.radians(90 - self.solar_zenith_angle))
